...
#define LADDER_RECEIVE_CARGO_HEIGHT 1000//2000
#define LADDER_RECIEVE_HATCH_HEIGHT 3500

#define LADDER_HATCH_TOP_HEIGHT    30000
#define LADDER_HATCH_MID_HEIGHT    16000
#define LADDER_HATCH_BOTTOM_HEIGHT 1000//0 //3500
